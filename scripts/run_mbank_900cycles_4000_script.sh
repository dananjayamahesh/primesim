CONF_NAME=syncbench-mbank-900cycles-4000
	...
	do
			...
			do	
				...
				do
					...
					${HOME}/repos/primesim/xml/config_mbank_900cycles_${pmodel}.xml \
					...
					-c ${HOME}/repos/primesim/xml/config_mbank_900cycles_${pmodel}.xml \
