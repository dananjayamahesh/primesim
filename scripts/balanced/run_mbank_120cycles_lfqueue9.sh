...
#9 parity load is 8B and lfqueue is nms non-micheal scott queue
#Remeber parity load is 8Bytes

CONF_NAME=syncbench-mbank-120cycles-nopfixed-9-lfqueue
...
for rate2 in 8000 64000 1000000
do
for rate in 1000 
do
