...
CONF_NAME=syncbench-mbank-300cycles-nopfixed-6
	...
	do
			...
			do	
				...
				do
					...
					${HOME}/repos/primesim/xml/config_msocket_300cycles_${pmodel}.xml \
					...
					-c ${HOME}/repos/primesim/xml/config_msocket_300cycles_${pmodel}.xml \
