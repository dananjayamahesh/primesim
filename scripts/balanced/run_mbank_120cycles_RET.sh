...
##Did not run for 25
#44-3 has stat print fixed with shares and invals. als 44-4 (regular one has partially)

#42-5 and 42-6 has full stat including invals

#RET Evaluation only for the hashmap-8 threads and 4000 operations.
#03 - with stats 1000 operations.
#04 - 4000
#05 - res cycle 2000
#06 - res cycle 4000
#7 1000
...
#11 lfqueue2 10000
#12 lfqueue 10000
CONF_NAME=syncbench-mbank-120cycles-nopfixed-RET-12
