CONF_NAME=syncbench-nonmbank-900cycles-4000
	...
	do
			...
			do	
				...
				do
					...
					${HOME}/repos/primesim/xml/config_nonmbank_900cycles_${pmodel}.xml \
					...
					-c ${HOME}/repos/primesim/xml/config_nonmbank_900cycles_${pmodel}.xml \
