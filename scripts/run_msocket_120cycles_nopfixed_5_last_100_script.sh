...
#after fixing all 3 errors.

#RUn History
#syncbench-msocket-120cycles-nopfixed-4 ->initial run after fixing rp writeback delays
...
#5 fixed write back delay for core 0

CONF_NAME=syncbench-msocket-120cycles-nopfixed-5-2_last_100
