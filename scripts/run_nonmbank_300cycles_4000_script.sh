CONF_NAME=syncbench-nonmbank-300cycles-4000
	...
	do
			...
			do	
				...
				do
					...
					${HOME}/repos/primesim/xml/config_nonmbank_300cycles_${pmodel}.xml \
					...
					-c ${HOME}/repos/primesim/xml/config_nonmbank_300cycles_${pmodel}.xml \
