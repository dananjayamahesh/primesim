...
#define CAS(_m, _o, _n) DIMP_compare_and_swap_full(((VOLATILE AO_t*) _m), ((AO_t) _o), ((AO_t) _n))

#define FAI(a) DIMP_fetch_and_add_full((VOLATILE AO_t*) (a), 1)
#define FAD(a) DIMP_fetch_and_add_full((VOLATILE AO_t*) (a), -1)
