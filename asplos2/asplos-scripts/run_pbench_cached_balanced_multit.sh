...
#optype=balanced
echo "Cached Multit Mode"

mode="zfix-multit-balanced-4000-16"
...
num_threads=16 #number of threads --all
...
#ops_pp=6000 #tested under 10k
ops_pp=4000 #tested under 10k
urate=100 #syncbench update rate
lfd_size=64000
rate2=64000
initial_size=1000
benchmark=all #deafult run all
