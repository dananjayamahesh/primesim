...
def main():
    ...
    for prog_name in progs:
        ...
        str_wb_all_line = ""
        str_wb_tot_line = ""
        str_wb_total_line = "" #All writeback count.
        #effective_ratio = 0.8
        str_lrp_line = ""
        #lrp_ratio = 0.5
        pf_ratio = 0.5
        ...
        for line in infile:
            ...
            if count % 7 == 0:
                ...
                if (count % 7 == 2) or (count % 7 == 3) or (count % 7 == 4) or (count % 7 == 5):
                    ...
                    str_wb_total_line = ","+ str(all_wb)+ "\t"+str_wb_total_line
            ...
            if count % 7 == 6:
                ...
                if(tline_fileds[0] == prog_name):
                    ...
                    print(prog_name+"  \t"+str_wb_total_line)
                    wb_output.write(prog_name+"  \t"+str_wb_total_line+'\n') #wb_total
