...
#mode="zfix-uncached-alternate-3000-32"

mode="zfix-uncached-alternate-2000-32"
...
#Configurations
#num_threads=32
alter="-A" #Large benchmarks.

max_operations=100000 #nb_threads*per_thread_ops
ops_pp=2000 #previously 3000
urate=100 #syncbench update rate
lfd_size=64000
rate2=64000
initial_size=1000
benchmark=linkedlist #default all
